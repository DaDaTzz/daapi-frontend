...
/** regenerateAKSK POST /api/user/regenerateAKSK */
export async function regenerateAkskUsingPost(
  body: API.RegenerateAKSKRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/user/regenerateAKSK', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
